...
import { FileText, Image, Video, Link as LinkIcon, Download, ExternalLink, BookMarked, Sparkles, Users, FileStack, Recycle, BookOpen } from 'lucide-react';
      ...
      <section className="py-16 bg-gradient-to-br from-emerald-800 via-emerald-700 to-teal-700 text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <NewsletterSignup variant="banner" source="resources" />
